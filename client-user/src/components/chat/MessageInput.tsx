...
export function MessageInput({ onSend, disabled }: MessageInputProps) {
  ...
  const handleFile = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      // result.filename is the stored filename; pass it as imageUrl
  ...
  return (
    <div className="flex items-end gap-2 p-3 bg-white border-t border-gray-200">
      ...
      <textarea
        ...
        disabled={disabled}
        rows={1}
        className="flex-1 resize-none rounded-2xl border border-gray-200 px-4 py-2 text-sm focus:outline-none focus:border-green-400 max-h-32 overflow-y-auto"
